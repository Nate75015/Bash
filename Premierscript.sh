...
ex : /Users/damienmarque/Stage/Deuxième-Partie/PMML/tmp_rf1.pmml"
read cheminmodele
...
do
	echo "ano_menage;avg_11;var_11;N_DaysNegatif_11;S_Negatif_11;N_TRX_ALL_11;S_DEBIT_ALL_11;S_TRX_ALL_11;P_DEBIT_ALL_11;S_TRX_EPARGNE_11;N_TRX_CREDITS_11;S_DEBIT_CREDITS_11;S_CREDIT_CREDITS_11;S_TRX_CREDITS_11;P_DEBIT_CREDITS_11;QCPTSAGED02;QCPTSAGED03;QCPTSAGED04;MSAGED53;MADMPRIF;MSAGED51;MSAGED63;MACMAFF;NSCO064;STATUT_RC;menage_multi;echantillon;pred_cv_rf" > Entre.csv
	for i in `seq 1 $nombreligne`;
 		do echo "4;-5792.185;76864.9952465517;30;-173765.55;30;-1090.81;41.5899999999999;49.06;1.58999999999993;1;0;40;40;0;0;0;1;1395;293;1395;0;293;1;1;0;1;0.096" >> Entre.csv 
 	done	

		BEFORE=$($DATE +'%s')

		java -Xms256m -Xmx2g -cp example-1.3-SNAPSHOT.jar -XX:-UseGCOverheadLimit org.jpmml.evaluator.EvaluationExample --model $cheminmodele --input Entre.csv --output OutputTest1.csv
